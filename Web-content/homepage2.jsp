...
<html lang="en">
<head>
  <title>JOBS-IN/Home Page/User</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="homepage2.jsp">Home</a></li>
  ...
  <!-- ------------------------Connect to the database---------------------- -->
	...
	try{
		...
		Statement stmt=con.createStatement();
		 ...
		 rs=stmt.executeQuery("select * from JobInformation");
				    ...
				    <div class="modal-dialog modal-sm">
				      <div class="modal-content">
				        <div class="modal-header">
				          ...
				          <h4 class="modal-title">More details about company</h4>
				        </div>
				        <div class="modal-body">
				        <table>
				          <tr><td>Job Id </td><td> <%= rs.getInt(2) %></td></tr>
				          <tr><td>Company Name </td><td> <%= rs.getString(3) %></td></tr>
				          <tr><td>Job Title </td><td> <%= rs.getString(4) %></td></tr>
				          <tr><td>Job Type </td><td> <%= rs.getString(5) %></td></tr>
				          <tr><td>Job Description </td><td> <%= rs.getString(6) %></td></tr>
				          <tr><td>Job Location </td><td> <%= rs.getString(7) %></td></tr>
				          <tr><td>Salary </td><td> <%= rs.getString(8) %></td></tr>
				          <tr><td>Mobile No </td><td> <%= rs.getString(9) %></td></tr>
                  <tr><td>Working day </td><td> <%= rs.getString(10) %></td></tr>
				        </table>
                </div>
              </div>
            </div>
