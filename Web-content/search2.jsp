        ...
        <div class="profile-card floatleft">
              <div class="image-container">
                <img src="image/hire1.jpg" alt="photo" width="100%">
                  <div class="title">
                    <p><i class="fa fa-building info"></i>Company name:-&nbsp<%=rs.getString(2)%></p>
                  </div>
                  <div class="main-container">
                  <p><i class="fa fa-briefcase info"></i>Job title:-&nbsp<%=rs.getString(3)%></p>
                  <p><i class="fa fa-map-marker info" ></i>Location:-&nbsp<%=rs.getString(6)%></p>
                  <hr>
                  </div>
              </div>
             </div>  
